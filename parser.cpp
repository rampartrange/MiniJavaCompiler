...
#line 30 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.y"
...
#line 65 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.cpp"
...
namespace yy {
#line 157 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.cpp"
...
#line 109 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.y"
...
#line 727 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.cpp"
    break;

  case 3: // assignments: %empty
#line 112 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.y"
           { yylhs.value.as < AssignmentList* > () = new AssignmentList(); /* A -> eps */}
#line 733 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.cpp"
    break;

  case 4: // assignments: assignments assignment
#line 113 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.y"
                             {
...
#line 741 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.cpp"
    break;

  case 5: // assignment: "identifier" ":=" exp
#line 118 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.y"
                          {
...
#line 750 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.cpp"
    break;

  case 6: // exp: "integer"
#line 127 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.y"
              {yylhs.value.as < Expression* > () = new NumberExpression(yystack_[0].value.as < int > ()); }
#line 756 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.cpp"
    break;

  case 7: // exp: "identifier"
#line 128 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.y"
                   {yylhs.value.as < Expression* > () = new IdentExpression(yystack_[0].value.as < std::string > ()); }
#line 762 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.cpp"
    break;

  case 8: // exp: exp "+" exp
#line 129 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.y"
                  { yylhs.value.as < Expression* > () = new AddExpression(yystack_[2].value.as < Expression* > (), yystack_[0].value.as < Expression* > ()); }
#line 768 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.cpp"
    break;

  case 9: // exp: exp "-" exp
#line 130 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.y"
                  { yylhs.value.as < Expression* > () = new SubstractExpression(yystack_[2].value.as < Expression* > (), yystack_[0].value.as < Expression* > ()); }
#line 774 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.cpp"
    break;

  case 10: // exp: exp "*" exp
#line 131 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.y"
                  { yylhs.value.as < Expression* > () = new MulExpression(yystack_[2].value.as < Expression* > (), yystack_[0].value.as < Expression* > ()); }
#line 780 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.cpp"
    break;

  case 11: // exp: exp "/" exp
#line 132 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.y"
                  { yylhs.value.as < Expression* > () = new DivExpression(yystack_[2].value.as < Expression* > (), yystack_[0].value.as < Expression* > ()); }
#line 786 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.cpp"
    break;

  case 12: // exp: "(" exp ")"
#line 133 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.y"
                  { yylhs.value.as < Expression* > () = yystack_[1].value.as < Expression* > (); }
#line 792 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.cpp"
    break;


#line 796 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.cpp"
...
#undef YYCASE_
  ...
  parser::yypact_[] =
  {
     -11,     1,   -10,   -11,    -2,    14,   -11,   -11,     9,   -11,
      -5,    -2,    -2,    -2,    -2,    -2,   -11,     9,    15,    15,
     -11,   -11
  };
  ...
  parser::yytable_[] =
  {
      10,     3,    12,    13,    14,    15,     4,    17,    18,    19,
      20,    21,    16,     5,     4,     6,    12,    13,    14,    15,
      11,     9,     0,     6,    14,    15
  };
  ...
  parser::yycheck_[] =
  {
       4,     0,     7,     8,     9,    10,    16,    11,    12,    13,
      14,    15,    17,    23,    16,    25,     7,     8,     9,    10,
       6,    23,    -1,    25,     9,    10
  };
  ...
  parser::yystos_[] =
  {
       0,    31,    32,     0,    16,    23,    25,    33,    34,    23,
      34,     6,     7,     8,     9,    10,    17,    34,    34,    34,
      34,    34
  };
  ...
  "\"real\"", "\"string\"", "\"bool\"", "CMP", "$accept", "unit",
  ...
  parser::yyrline_[] =
  {
       0,   109,   109,   112,   113,   118,   127,   128,   129,   130,
     131,   132,   133
  };
...
#line 1269 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.cpp"

#line 135 "/Users/rampartrange/MIPT-HW/MiniJavaCompiler/parser.y"
